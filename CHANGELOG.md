...
- Profile personal parameters section for the authenticated `/profile` tab, including canonical `user-parameters` read/update flow, editable profile form card, weekly-goal save support, and shared workouts reload invalidation after successful submit.
