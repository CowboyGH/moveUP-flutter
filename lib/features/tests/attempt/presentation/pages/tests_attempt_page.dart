...
/// Authenticated page for a single test attempt.
class TestsAttemptPage extends StatefulWidget {
  /// Testing identifier used for start retry.
  final int testingId;

  /// Creates an instance of [TestsAttemptPage].
  const TestsAttemptPage({
    required this.testingId,
    super.key,
  });

  @override
  State<TestsAttemptPage> createState() => _TestsAttemptPageState();
}

class _TestsAttemptPageState extends State<TestsAttemptPage> {
  ...
  void _returnToCatalog() {
    ...
    router.go(AppRoutePaths.testsPath);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<TestAttemptCubit, TestAttemptState>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            leading: AppBackButton(onPressed: _returnToCatalog),
            title: Text(AppStrings.testsAttemptTitle, style: textTheme.appBarTitle),
          ),
          body: Stack(
            fit: StackFit.expand,
            children: [
