...
/// Retrofit API client for tests catalog and guest attempt requests.
@RestApi()
abstract class TestsApiClient {
  ...
  Future<SaveGuestTestResultResponseDto> saveGuestTestResult(
    @Path('attempt') String attemptId,
    @Body() SaveGuestTestResultRequestDto request,
  );
