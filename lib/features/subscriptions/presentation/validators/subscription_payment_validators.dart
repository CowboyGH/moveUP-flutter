...
/// Shared validators for subscription payment form fields.
abstract final class SubscriptionPaymentValidators {
  static const _hiddenValidationError = 'invalid';
  static const _maxFutureYears = 20;
  static final _cardHolderPattern = RegExp(r'^[A-Z ]+$');

  /// Validates a payment card number.
  ...
  /// Validates a payment card holder.
  ...
  /// Validates a payment expiry month.
  ...
  /// Validates a payment expiry year.
