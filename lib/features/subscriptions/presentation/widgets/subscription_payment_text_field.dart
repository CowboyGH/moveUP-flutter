...
/// Payment-specific text field used only inside the subscriptions checkout flow.
class SubscriptionPaymentTextField extends StatelessWidget {
  /// Text controller.
  ...
  /// Creates an instance of [SubscriptionPaymentTextField].
  const SubscriptionPaymentTextField({
